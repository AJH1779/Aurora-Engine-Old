...
public final class HDAng {
     ...
     */
    public HDAng(double x, double y, double z, double ang) { set(x, y, z, ang); }
    /**
     ...
     * @param ang The rotation angle in radians
     */
    public HDAng(HDVec vec, double ang) { set(vec, ang); }
    /**
     ...
     * @return This
     */
    public HDAng set(double x, double y, double z, double ang)
     ...
     * @return This
     */
    public HDAng set(HDVec vec, double ang) { set(vec); return set(ang); }
    /**
